...
struct data_sum {
  ...
  float avc;/*Average conversion tract length*/
  float th;/*Theta per site*/
  float rho;/*Rho for whole gene (or gamma for conversion model)*/
  int rho_i;/*position of maximum rho*/
  float rho_drive;/*Rho to be used in driving simulations*/
  float fit_obs;/*Observed fit*/
  ...
  float rme;/*Number of points for rho in coalescent likelihood estimation*/
  float rmax;/*Max rho in coalescent likelihood estimation*/
