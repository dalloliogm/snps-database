	   ...
	   for (d=0;d<=pset->pt[7];d++)
	    for (e1=0;e1<=pset->pt[8];e1++)
		 for (e2=0;e2<=pset->pt[8]-e1;e2++)
		  ...
		  /*		  printf("\n%3i %3i %3i %3i: %i",pres[0], pres[1], pres[2], pres[3], mydata->nseq*((int) 1 + (mydata->hd==1?0:1)));*/
		  ...
		  /*		  printf("\n%3i %3i %3i %3i: %i %i %i",pres[0], pres[1], pres[2], pres[3], p1>mydata->nseq?1:0,p2>mydata->nseq?1:0,p2>p1?1:0 );
				  printf("\n ht = %i",ht);*/
